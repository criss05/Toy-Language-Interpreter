...
import com.example.a7gui.model.types.*;
...
public class Interpreter {
    public static void run() {
        ...
        //int v; v=2;Print(v)
        IStatement ex1 = new CompStatement(new VarDeclStatement("v", new IntType()), new CompStatement(new AssignmentStatement("v", new ValueExpression(new StringValue("2"))), new PrintStatement(new VariableExpression("v"))));
        try {
